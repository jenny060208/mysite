...
<script type="text/javascript">
      ...
      jQuery(function($)
      {
        $(document).ready(function()
        {
          ...
          obj = document.getElementById("profile_detail_id");
			...
			<div class="col-sm-5">
				...
				<table class="table table-bordered" style="margin-top: 50px;">
					...
					<tbody>
						<tr>
							<td
								style="vertical-align: middle; text-align: left; font-weight: bold; vertical-align: middle; text-align: left">Email
								Transfer:</td>
							<td style="vertical-align: middle; text-align: left;"><?php echo ($paymentMethodInfo["ETransfer"]); ?></td>
						</tr>
						<tr>
							<td
								style="vertical-align: middle; text-align: left; font-weight: bold; vertical-align: middle; text-align: left">Credit
								Card:</td>
							<td style="vertical-align: middle; text-align: left;"><?php echo ($paymentMethodInfo["paypal"]); ?></td>
						</tr>
						<tr>
							<td
								style="vertical-align: middle; text-align: left; font-weight: bold; vertical-align: middle; text-align: left">Note:</td>
							<td style="vertical-align: middle; text-align: left;"><?php echo ($paymentMethodInfo["note"]); ?></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<div class="panel panel-default text-center"
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" id="bn_temp_msg_form"
							...
							action="/neo1/index.php/home/business/business_db1_general.html">
