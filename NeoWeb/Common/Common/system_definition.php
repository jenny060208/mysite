...
class SysDefinition
{
    ...
    const BN_EMAIL_CONFIG = array(
        ...
        "REPLY_EMAIL" => "elecdesign9@gmail.com", // Reply email ï¼ˆif null, use sender's emailï¼‰
        "REPLY_NAME" => "Neo Reward"
    );

    // Reply name ï¼ˆif null, user sender's nameï¼‰
    const NEO_ADMIN_EMAIL = "jamesw789@gmail.com";

    const NEO_ADMIN_NAME = "Neo Sales Team";

    // HEX: 10 0001
    const TAG_INDEX_MIN = 1048577;

    // HEX: FF FF00
    const TAG_INDEX_MAX = 16776960;

    // HEX: 1000 0001
    const TAG_NUMBER_MIN = ‭268435457‬;

    // HEX: FFFF F000
    const TAG_NUMBER_MAX = 4294963200;
