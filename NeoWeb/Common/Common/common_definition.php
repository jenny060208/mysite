...
class CommonDefinition {
	...
	const REG_BIRTHDAY_ID_1 = 8; // only check day and month of(dd/mm)
	                             
	// Define the promotion notice preference method
	const USER_NOTICE_DISABLE = 1; // user notification is disable
	const USER_NOTICE_SMS_ONLY = 2; // user notification by SMS only
	const USER_NOTICE_EMAIL_ONLY = 3; // user notification by EMail only
	const USER_NOTICE_ALL = 4; // user notification by both sms and email
	                           
	// Define Contact message type information
	const MSG_FLAG_NEW = 1;
	const MSG_FLAG_PROCESSED = 20;
	const TAG_STR_LENGTH = 10; // Define the tag string length
	const TAG_SRC_QR_CODE = 1; // Tag from QR code
	const TAG_SRC_NFC = 2; // Tag from NFC
	const TAG_SRCSMS = 3; // Tag from SMS
	                      
	// Define Contact Message related
	const MAX_CONTACT_MSG_LENGTH = 300; // Maximum 300 characters
	const MAX_CONTACT_MSG_SUBJECT_LENGTH = 100; // Maximum 300 characters
	                                            
	// Define Tax rate
	const TAX_RATE_CANADA = 1.13; // Tax rate Canada
	const TAX_RATE_INT = 1.00; // Tax rate outside of Canada
	                           
	// Payment method definition
	const PAY_METHOD_EMAIL = 1; // email transfer
	const PAY_METHOD_PAYPAL = 2; // Paypal
	const PAY_METHOD_CREDIT_CARD = 3; // credit card
	                                  
	// Payment method detail definition
	const PAY_METHOD_EMAIL_MSG = "Email Transfer"; // email transfer
	const PAY_METHOD_PAYPAL_MSG = "Paypal Method"; // Paypal
	const PAY_METHOD_CREDIT_CARD_MSG = "Credit Card method"; // credit card
