...
class AllTableInfoDefinition {
	...
	const NEO_TBL_NAME_BUSINESS_MORE_INFO_INFO = 'neo_bn_serv_enquiry_tbl'; // General business enquiry service more info
	                                                                        // table
	const NEO_TBL_NAME_GEN_CONTACT_INFO = 'neo_general_in_touch_tbl'; // General get in touch table
	const NEO_TBL_NAME_TAG_INFO = 'neo_tag_info_tbl'; // Tag to the specified webpage and business ID table
	const NEO_TBL_NAME_PREFIX_TAG_SCAN_EVENT = 'bn_tag_scan_evt_'; // Tag scan log event table name prfix
	const NEO_TBL_NAME_TAG_SCAN_ERROR_EVENT = 'neo_tag_scan_error_log_tbl'; // Tag scan error code log event table name
	const NEO_TBL_NAME_PREFIX_TAG_USER_REGIST = 'bn_tag_user_regist_'; // Tag user regist table name prfix
	...
	// TAG related info
	const DB_FIELD_TAG_ID = "tag_id"; // TAG ID
	const DB_FIELD_TAG_INDEX = "tag_index"; // TAG index
	const DB_FIELD_TAG_SRC = "tag_src"; // TAG source: 1--> QR Code; 2--> NFC; 3--> SMS;
	const DB_FIELD_TAG_NUMBER = "tag_number"; // Tag number
	const DB_FIELD_TAG_LABEL = "tag_label"; // Tag label
	const DB_FIELD_TAG_WEB_PAGE = "tag_web_page"; // Tag web page
	const DB_FIELD_TIME = "date"; // date/time related field
	...
	const DB_FIELD_DEVICE_TYPE = "device_type"; // Device type such as mobile or PC, etc
	const DB_FIELD_BROWSER_TYPE = "browser_type"; // Browser type, such as Chrome, firefox, etc
