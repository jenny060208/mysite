...
class UserApi extends Api
{
   ...
   {
      $d_user_reg = array();
      $d_user_reg['user_name']        = $reg_data->user_name;        //User Name
      $d_user_reg['user_email']       = $reg_data->user_email;       //user email
      $d_user_reg['user_mobile']      = $reg_data->user_mobile;      //user mobile
      $d_user_reg['user_postal_code'] = $reg_data->user_postal_code; //user postal code
      $d_user_reg['user_password']    = $reg_data->user_password;    //user postal code
