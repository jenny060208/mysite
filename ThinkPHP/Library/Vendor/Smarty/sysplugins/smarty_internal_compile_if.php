...
class Smarty_Internal_Compile_If extends Smarty_Internal_CompileBase {
	...
	public function compile($args, $compiler, $parameter) {
		...
		$this->openTag ( $compiler, 'if', array (
				1,
				$compiler->nocache 
		) );
...
class Smarty_Internal_Compile_Else extends Smarty_Internal_CompileBase {
	 ...
	 */
	public function compile($args, $compiler, $parameter) {
		list ( $nesting, $compiler->tag_nocache ) = $this->closeTag ( $compiler, array (
				'if',
				'elseif' 
		) );
		$this->openTag ( $compiler, 'else', array (
				$nesting,
	...
	public function compile($args, $compiler, $parameter) {
		...
		if (empty ( $compiler->prefix_code )) {
			if ($condition_by_assign) {
				$this->openTag ( $compiler, 'elseif', array (
						$nesting + 1,
						$compiler->tag_nocache 
				) );
				if (is_array ( $parameter ['if condition'] ['var'] )) {
...
class Smarty_Internal_Compile_Ifclose extends Smarty_Internal_CompileBase {
	...
	public function compile($args, $compiler, $parameter) {
		...
		list ( $nesting, $compiler->nocache ) = $this->closeTag ( $compiler, array (
				'if',
				'else',
				'elseif' 
		) );
